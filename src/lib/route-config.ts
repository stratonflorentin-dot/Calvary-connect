...
export const ROUTE_CONFIG: RouteConfig[] = [
  ...
  { path: "/expenses", label: "Expenses", allowedRoles: ["CEO", "ADMIN", "OPERATOR", "HR"] },
  { path: "/income", label: "Income", allowedRoles: ["CEO", "ADMIN", "HR"] },
  { path: "/fuel-approvals", label: "Fuel Approvals", allowedRoles: ["CEO", "ADMIN", "OPERATOR"] },
