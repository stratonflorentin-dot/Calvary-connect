  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      setStats({
        ...
        pendingQuotations: quotationsData.data?.filter((q: any) => q.approval_status === "draft").length || 0,
        approvedQuotations: quotationsData.data?.filter((q: any) => q.approval_status === "approved").length || 0,
