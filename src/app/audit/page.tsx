...
import { History, Search, Filter, ChevronRight, User, Database, Clock, Loader2, Trash2 } from 'lucide-react';
    ...
    <PageShell>
      <div className="space-y-6">
        <PageHeader
          ...
          subtitle="Trace every interaction and financial activity across the organization"
          icon={History}
          actions={
            <>
