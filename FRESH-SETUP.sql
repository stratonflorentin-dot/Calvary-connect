-- 🚀 FRESH SETUP - Use this for clean installation
...
-- Create RLS Policies (using DROP POLICY IF EXISTS to avoid conflicts)
-- User Profiles
...
-- Success message
SELECT '✅ Fresh Fleet Management Database Setup Complete!' as status,
       'All tables created with proper RLS policies and sample data.' as message;