...
ALTER TABLE driver_allowances ADD COLUMN IF NOT EXISTS employee_id VARCHAR(50);
...
CREATE INDEX IF NOT EXISTS idx_driver_allowances_employee_id ON driver_allowances(employee_id);
...
ALTER TABLE expenses ADD COLUMN IF NOT EXISTS employee_id VARCHAR(50);
...
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS employee_id VARCHAR(50);
