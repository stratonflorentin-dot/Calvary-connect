...
const ALL_TABLES = [
  ...
  'chat_typing', 'client_emails', 'clients', 'company_settings', 'compliance_documents',
  'contract_history', 'contract_templates', 'contracts', 'credit_notes', 'customer_activities',
  'customers', 'delivery_notes', 'departments', 'document_sequences', 'driver_allowances',
  'driver_location_history', 'driver_locations', 'employee_compensation', 'employee_loans',
  'event_log', 'exchange_rates', 'expenses', 'financial_categories', 'fiscal_periods',
  'fuel_anomalies', 'fuel_logs', 'fuel_records', 'fuel_requests', 'fuel_tracking', 'geofences',
  'income', 'instagram_conversations', 'instagram_messages', 'insurance_claims',
  'insurance_policies', 'inventory', 'invoices', 'journal_entries', 'journal_entry_lines',
  'leads', 'leave_requests', 'maintenance_records', 'maintenance_requests',
  'maintenance_schedules', 'meeting_attendees', 'meetings', 'mobile_money_transactions',
  'monthly_reports', 'notifications', 'overtime_entries', 'parts_requests', 'payment_allocations',
  'payments', 'payroll_periods', 'payroll_runs', 'payslip_loan_deductions', 'payslips',
  'performance_reviews', 'proof_of_delivery', 'purchases', 'quotations', 'rate_sheets', 'reports',
  'route_constraints', 'route_quotations', 'route_role_overrides', 'sales', 'sales_opportunities',
  'schema_migrations', 'sensor_readings', 'sensors', 'shipments', 'spare_parts',
  'sustainability_metrics', 'taxes', 'tire_tracking', 'transport_contracts', 'trip_revenue',
  'trips', 'truck_insurance', 'user_profiles', 'vehicle_costs', 'vehicle_deletion_audit',
  'vehicle_documents', 'vehicle_inspections', 'vehicle_locations', 'vehicle_service_records',
  'vehicles', 'whatsapp_messages',
];
